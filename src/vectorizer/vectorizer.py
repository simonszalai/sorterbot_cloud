...
class Vectorizer:
    ...
    def run(self, session_id, images, n_containers):
        """
        ...
        images : list
            List of dicts containing information describing the images and the recognized objects. `image_name` and `bbox_dims` are
