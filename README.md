...
### Deploy to AWS
You can deploy SorterBot Cloud to AWS as part of the SorterBot service. Please refer to the 'Production' section of the [README in the SorterBot Installer](https://github.com/simonszalai/sorterbot_installer) repository.
