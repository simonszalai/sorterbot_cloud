...
RUN --mount=type=secret,id=aws_credentials,dst=/root/.aws/credentials aws s3 cp s3://sorterbot-weights/model_final2.pth /sorterbot_cloud/src/weights/model_final.pth
